...
public class EntityController {
	...
	public static Entity makeEntity(int x, int y, char c) {
		switch (c) {
			case 'r' : return new Item(ItemType.REDKEY, x, y);
			case 'g' : return new Item(ItemType.GREENKEY,x ,y);
			case 'b' : return new Item(ItemType.BLUEKEY,x ,y);
			case 'y' : return new Item(ItemType.YELLOWKEY, x ,y);
			case 'f' : return new Item(ItemType.FIREBOOTS, x, y);
			case 'w' : return new Item(ItemType.FLIPPERS, x, y);
			case '*' : return new Item(ItemType.TOKEN, x, y);
			default : return null;
        }
	}
