...
public class EntityController {
	 ...
	 *
	 * @param entityGrid
	 *            2d Array of Enemy and Item Entity SubClasses.
	 * @param enemies
	 */
	 ...
	 *
	 * @param player
	 *            The Player object for position reference.
	 */
	 ...
	 *
	 * @param player
	 *            The player object where the position will be checked in the
	 *            entityGrid.
	 ...
	 *
	 * @param x
	 *            The horizontal position of the item in the grid.
	 * @param y
	 *            The vertical position of the item in the grid.
	 */
	 ...
	 *
	 * @param map
	 *            the map will be passed through to each enemy to assist their
	 ...
	 *
	 * @param line
	 *            the scanner of a line with the player information
	 ...
	 *
	 * @param line
	 *            the scanner of the rest of the line including specific details
	 * @param pos
	 *            the position the enemy is created at
	 ...
	 *
	 * @param line
	 *            a scanner of the line with the enemy details
	 * @return
	 */
	 ...
	 * @param y
	 *            the y positio of the item
	 * @param c
	 *            the character in the map file
